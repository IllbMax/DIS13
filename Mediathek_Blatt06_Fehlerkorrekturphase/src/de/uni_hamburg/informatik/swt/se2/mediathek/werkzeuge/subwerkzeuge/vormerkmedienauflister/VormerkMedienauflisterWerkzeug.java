...
/**
 * Ein {@link VormerkMedienauflisterWerkzeug} ist ein Werkzeug zum Auflisten von
 * Medien mit ihren für das Vormerken relevanten Verleihinformationen.
 * 
 ...
 * @version SoSe 2012
 */
public class VormerkMedienauflisterWerkzeug extends BeobachtbaresSubWerkzeug
{
    ...
    /**
     * Initialisiert ein neues {@link VormerkMedienauflisterWerkzeug}. Es wird
    ...
    private void setzeAnzuzeigendeMedien()
    {
        ...
        for (Medium medium : medienListe)
        {
            ...
            Kunde vormerker1 = _vormerkService.getVormerker(medium, 0);
            Kunde vormerker2 = _vormerkService.getVormerker(medium, 1);
            Kunde vormerker3 = _vormerkService.getVormerker(medium, 2);
