...
/**
 * Ein {@link AusleihWerkzeug} stellt die Funktionalität der Ausleihe für die
 * Benutzungsoberfläche bereit. Die UI wird durch die {@link AusleiheUI}
 * gestaltet.
 * 
 * @author SE2-Team
 * @version SoSe 2012
...
public class AusleihWerkzeug
{
    ...
    /**
     * Initialisiert ein neues {@link AusleihWerkzeug}. Es wird die
    ...
    private boolean istAusleihenMoeglich()
    {
        ...
        boolean ausleiheMoeglich = (kunde != null) && !medien.isEmpty()
                ...
                && (_vormerkService.sindAlleLeihbar(kunde, medien));
    ...
    private void leiheAusgewaehlteMedienAus()
    {
        ...
        try
        {
            ...
            {
                if(_vormerkService.getVormerker(medium, 0).equals(selectedKunde))
                {
                    _vormerkService.loescheErsteVormerktung(medium);
                }
            }
        }
